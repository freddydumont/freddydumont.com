...
> &mdash; <cite>[Derek Nguyen](https://stackoverflow.com/users/10340970/derek-nguyen) on [Stack Overflow](https://stackoverflow.com/a/56012718)</cite>
...
The takeaway here is that whether you need to process your data before sending it to your GraphQL tree, or you need images processed by `gatsby-plugin-sharp` under a specific node, using the `sourceNodes` API in conjunction with the `createNode` action will help you achieve your goals.
